...
| 用户故事 | 测试文件 | 覆盖的场景 |
|----------|----------|------------|
| US-01 页面加载 | `ci/pageLoad.spec.ts` | 6/8 场景 |
| US-02 订阅管理 | `ci/feedSubscription.spec.ts` | 5/10 场景 |
| US-03 文章阅读 | `ci/feedSubscription.spec.ts` | 11/11 场景 |
...
| 用户故事 | 缺失场景 | 优先级 |
|----------|----------|--------|
| US-04 收藏功能 | 全部（7个场景） | 🔴 高 |
| US-05 阅读历史 | 全部（6个场景） | 🔴 高 |
| US-06 搜索功能 | 全部（6个场景） | 🟡 中 |
| US-07 订阅管理页 | 全部（6个场景） | 🟡 中 |
| US-01 页面加载 | 搜索页、管理页（2个场景） | 🟡 中 |
